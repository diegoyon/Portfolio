...
const projects = [
  {
    name: "To Do List",
    description:
      'In this project I made a simple To Do List that allows the user to add tasks, edit them, mark as "completed" and/or delete them. I also implemented the drag and drop feature that lets the user drag a task and move it to another position.',
    featuredImg: "./images/todolist.PNG",
    technologies: ["HTML", "CSS", "JavaScript", "Webpack"],
    linkLive: "https://diegoyon.github.io/todolist/dist/",
  ...
  },
  {
    name: "Project5",
    description:
      "Lorem Ipsum 5 is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the releaLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the relea",
  ...
  },
  {
    name: "Project6",
    description:
      "Lorem Ipsum 6 is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the releaLorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it 1960s with the relea",
